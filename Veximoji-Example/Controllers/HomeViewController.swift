...
//    tableView.register(FlagsListCell.self, forCellReuseIdentifier: FlagsListCell.reuseId)
...
//  }
//
//  func presentDetailView(data: EmojiFlag, cell: FlagsListCell) {
...
//    let cell = tableView.dequeueReusableCell(withIdentifier: FlagsListCell.reuseId, for: indexPath) as! FlagsListCell
//
